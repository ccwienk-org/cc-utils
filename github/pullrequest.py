...
def split_into_chunks_if_too_long(
    ...
    If string is shorted than allowed max_leng, the string will be returned unchanged, along with
    ...
    # string is too long
    first = f'{string[0: len(split_hint)]}{split_hint}'
    string = string[len(split_hint):]
...
def upgrade_pullrequest_body(
    ...
    return split_into_chunks_if_too_long(
        ...
        max_leng=github.limits.pullrequest_body,
